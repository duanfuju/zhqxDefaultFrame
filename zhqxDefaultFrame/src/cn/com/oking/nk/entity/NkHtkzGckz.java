...
/**
 * NK_HTKZ_GCKZ:合同控制之过程控制
 */
@Entity
@Table(name = "NK_HTKZ_GCKZ")
public class NkHtkzGckz implements Serializable {
	...
	public NkHtkzGckz(String id, String nkNum, String content, Date upDate,
	...
	public String toString() {
		return "NkHtkzGckz [id=" + id + ",nkNum=" + nkNum + ",content="
