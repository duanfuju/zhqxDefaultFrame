 ...
 */
@Entity
@Table(name = "NK_RECORD")
public class NkRecord implements Serializable {
	...
	public NkRecord(String id, String nkNum, String nkName, Date updateTime,
			String nkType, String fileid) {
		super();
		this.id = id;
		this.nkNum = nkNum;
		this.nkName = nkName;
	...
	public String toString() {
		return "NkRecord [id=" + id + ",nkNum=" + nkNum + ",nkName=" + nkName
				+ ",updateTime=" + updateTime + ",nkType=" + nkType
				+ ",fileid=" + fileid + "]";
	}
