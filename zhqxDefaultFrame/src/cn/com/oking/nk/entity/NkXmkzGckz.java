...
/**
 * NK_XMKZ_GCKZ:项目控制之过程控制
 */
@Entity
@Table(name = "NK_XMKZ_GCKZ")
public class NkXmkzGckz implements Serializable {
	...
	public NkXmkzGckz(String id, String nkNum, String content, Date upDate,
	...
	public String toString() {
		return "NkXmkzGckz [id=" + id + ",nkNum=" + nkNum + ",content="
