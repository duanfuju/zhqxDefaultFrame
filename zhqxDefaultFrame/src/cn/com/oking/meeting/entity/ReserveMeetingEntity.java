...
public class ReserveMeetingEntity {
	...
	private String peak_attendee;        //
	private String total_attendee;       //
	...
	public String getPeak_attendee() {
		return peak_attendee;
	}
	public void setPeak_attendee(String peak_attendee) {
		this.peak_attendee = peak_attendee;
	}
	public String getTotal_attendee() {
		return total_attendee;
	}
	public void setTotal_attendee(String total_attendee) {
