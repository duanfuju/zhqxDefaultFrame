...
/**
 * EM_CZFA_ML_ADVICE:处置命令引用建议
 */
@Entity
@Table(name = "EM_CZFA_ML_ADVICE")
public class EmCzfaMlAdvice implements Serializable {
	...
	public EmCzfaMlAdvice() {
		super();
	}

	public EmCzfaMlAdvice(String id, String dept, String responses,
	...
	public String toString() {
		return "EmCzfaMlAdvice [id=" + id + ",dept=" + dept + ",responses="
