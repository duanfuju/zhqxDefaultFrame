...
/**
 * MNYL_PROBLEMS_STANDARD_LIBRARY:模拟演练_脚本主表（问题）_标准库
 */
@Entity
@Table(name = "MNYL_PROBLEMS_STANDARD_LIBRARY")
public class MnylProblemsStandardLibrary implements Serializable {
	...
	public MnylProblemsStandardLibrary() {
		super();
	}

	public MnylProblemsStandardLibrary(String id, String ptype, String title,
			String problem, Date openTime, String caselibraryId,
			String drillMode, String roleSelection, String dept, String zhCase) {
		super();
		this.id = id;
		this.ptype = ptype;
		this.title = title;
	...
	public String toString() {
		return "MnylProblemsStandardLibrary [id=" + id + ",ptype=" + ptype
				+ ",title=" + title + ",problem=" + problem + ",openTime="
				+ openTime + ",caselibraryId=" + caselibraryId + ",drillMode="
				+ drillMode + ",roleSelection=" + roleSelection + ",dept="
				+ dept + ",zhCase=" + zhCase + "]";
	}
