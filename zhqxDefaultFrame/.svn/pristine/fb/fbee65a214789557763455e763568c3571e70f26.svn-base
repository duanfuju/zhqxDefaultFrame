...
<title>问题界面</title>
<%
	String zhCase=new String(request.getParameter("zhCase").getBytes("ISO-8859-1"),"UTF-8");
	String zhId=new String(request.getParameter("zhId").getBytes("ISO-8859-1"),"UTF-8");
	String drillMode=new String(request.getParameter("drillMode").getBytes("ISO-8859-1"),"UTF-8");
	String roleSelection=new String(request.getParameter("roleSelection").getBytes("ISO-8859-1"),"UTF-8");
