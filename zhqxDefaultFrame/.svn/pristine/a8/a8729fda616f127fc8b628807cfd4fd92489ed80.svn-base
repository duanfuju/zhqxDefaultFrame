    ...
    var viewport = new Ext.Viewport({
			...
			左侧菜单结束*/
		{
            ...
            items:[{
				...
				,{
                    title: '智能监控',
                    region: '<iframe src="/newzhqx/cn.com.oking.dataInterface.view.qxglIndex.d"   style="width:100%; height:450px; margin-left:-40px; margin-top:2px;" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>',
                    tools: tools,
                    html:'<iframe src="/newzhqx/cn.com.oking.dataInterface.view.qxglIndex.d"  name="hla" style="width:100%; height:390px;margin-left:0px;" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>'
                }
			...
			,{
				...
				{
                    title: '水文水位',
                    region: '<iframe src="http://218.2.99.66/pkqx/dorado/bumen/sl.html"   style="width:100%; height:450px; margin-left:1px; margin-top:2px;" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>',
                    tools: tools,
                    html:'<img src="2.png" height="180" />'
                }
				]
            }
